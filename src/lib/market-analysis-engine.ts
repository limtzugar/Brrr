...
export const WHAT_IF_SCENARIOS: WhatIfScenario[] = [
  {
    id: 'fed_cuts',
    name: 'Fed obniża stopy',
    emoji: '📉',
    description: 'Tańszy kapitał stymuluje tech/AI i rynki wzrostowe',
    impacts: { ai: 15, semi: 12, finance: 10, health: 5, energy: -5, esg: 8, biotech: 8, infra: 6, military: -3 },
  },
  {
    id: 'recession',
    name: 'Recesja globalna',
    emoji: '📉',
    description: 'Uderzenie w cykliczne sektory, flight to quality',
  ...
  },
  {
    ...
    name: 'Boom AI 2.0',
    emoji: '🚀',
    description: 'Masowa adopcja AI napędza cały ekosystem technologiczny',
